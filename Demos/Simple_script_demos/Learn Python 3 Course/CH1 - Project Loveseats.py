# Project CH1 
# Codecademy project on printing lists
# Loveseats project
# Code by Nova_Tago
Company = 'Lovely Loveseats for Neat Suites on Fleet Street'
...
customer_one_total_final = customer_one_total + customer_one_tax
print ('Customer One Items:')
print (customer_one_itemization)
print ('Customer One Total')
print (customer_one_total_final)